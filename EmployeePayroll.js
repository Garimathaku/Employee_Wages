...
const emp1 = new EmployeePayroll(101, "Garima", 5000, "Female", "2023-05-10");  
const emp2 = new EmployeePayroll(102, "Aaru", 7000, "Female", "2022-11-15"); 
const emp3 = new EmployeePayroll(103, "Abhi", 6000, "Male", "2024-01-20"); 
